#ifndef EcalValidationRelVal_rechitless_rechitless_h
#define EcalValidationRelVal_rechitless_rechitless_h
...
class EcalValidationRelVal_rechitless : public edm::EDAnalyzer {
  
      public:
         explicit EcalValidationRelVal_rechitless(const edm::ParameterSet&);
	 ~EcalValidationRelVal_rechitless();
