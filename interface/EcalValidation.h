...
edm::EDGetTokenT<EcalRecHitCollection>                    redRecHitCollection_EB_;//EcalRecHitCollection
...
edm::EDGetTokenT<ESRecHitCollection>                      esRecHitCollection_;//ESRecHitCollection
edm::EDGetTokenT<reco::PreshowerClusterCollection>              esClusterCollectionX_ ;//PreshowerClusterCollection
edm::EDGetTokenT<reco::PreshowerClusterCollection>              esClusterCollectionY_ ;
edm::EDGetTokenT<EBDigiCollection>                        ebDigiCollection_ ;//EBDigiCollection
edm::EDGetTokenT<EEDigiCollection>                        eeDigiCollection_ ;
edm::EDGetTokenT<EBSrFlagCollection>                      ebEcalDigiCollection_ ;//EBSrFlagCollection
edm::EDGetTokenT<EESrFlagCollection>                      eeEcalDigiCollection_ ;
edm::EDGetTokenT<edm::View<reco::Track> >                 tracks_ ;//edm::View<reco::Track>
edm::EDGetTokenT<reco::BeamSpot>                      	  beamSpot_ ;//reco::BeamSpot
edm::EDGetTokenT<reco::CaloJetCollection>                 jets_;//reco::CaloJetCollection
...
TH1D *nRecHits_EEP;
TH1D *nRecHits_EEM;
TH2D *RecHitVSEta_EEP;
TH2D *RecHitVSEta_EEM;
TH2D *RecHitVSPhi_EEP;
TH2D *RecHitVSPhi_EEM;
	 ...
	 TH1D *h_recHits_EB_OutOfTimeChi2_cleaned;
         TH2D *h_recHits_EEM_eneVSix      ;
         TH2D *h_recHits_EEM_eneVSchi2ix  ;
         TH2D *h_recHits_EEM_chi2VSix     ;
         TH2D *h_recHits_EEM_eneVSiy      ;
         TH2D *h_recHits_EEM_eneVSchi2iy  ;
         TH2D *h_recHits_EEM_chi2VSiy     ;
         TH2D *h_recHits_EEP_eneVSix      ;
         TH2D *h_recHits_EEP_eneVSchi2ix  ;
         TH2D *h_recHits_EEP_chi2VSix     ;
         TH2D *h_recHits_EEP_eneVSiy      ;
         TH2D *h_recHits_EEP_eneVSchi2iy  ;
         TH2D *h_recHits_EEP_chi2VSiy     ;
         TH2D *h_recHits_EB_eneVSieta      ;
         TH2D *h_recHits_EB_eneVSchi2  ;
         TH2D *h_recHits_EB_chi2VSieta     ;
