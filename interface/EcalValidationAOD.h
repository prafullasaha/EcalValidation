...
vector<float>    puTrue_, nPU_, puBX_, nPVz_;
vector<float>    recHitsEBtime, recHitsEBChi2;
	 // RecHits ----------------------------------------------
	 ...
	 TH1D *h_recHits_EB_energy;
         TH1D *h_recHits_EB_energy_thr;
         TH1D *h_recHits_EB_recoFlag;
         TH1D *h_recHits_EB_energyMax;
         TH1D *h_recHits_EB_sumEt;
          TH1D *h_recHits_EB_kOutOfTime;
          TH1D *h_recHits_EB_kWeird;

	 TH1D *h_recHits_EB_time;
	 TH1D *h_recHits_EB_Chi2;
	 TH1D *h_recHits_EB_time_cut;
	 TH1D *h_recHits_EB_Chi2_cut;
	 ...
	 TH1D *h_recHits_EB_OutOfTimeChi2_cleaned;
         ...
         //... barrel (selected cuts.)
	 TH1D *h_recHits_EB_size_selected; 
	 TH1D *h_recHits_EB_energy_selected;
         TH1D *h_recHits_EB_recoFlag_selected;
         TH1D *h_recHits_EB_energyMax_selected;
         TH1D *h_recHits_EB_sumEt_selected;
	 TH1D *h_recHits_EB_time_selected;
	 TH1D *h_recHits_EB_Chi2_selected;
	 TH1D *h_recHits_EB_OutOfTimeChi2_selected;
	 TH1D *h_recHits_EB_E1oE4_selected; 
         TH1D *h_recHits_EB_iPhiOccupancy_selected;
         TH1D *h_recHits_EB_iEtaOccupancy_selected;
	 TH2D *h_recHits_EB_occupancy_selected;
	 TH2D *h_recHits_EB_deviation_selected;
