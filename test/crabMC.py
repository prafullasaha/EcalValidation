...
###for data
config.General.requestName = 'NuGunMCMini_AOD_new_Cut'
#config.JobType.psetName = 'ecalvalidationDATAAOD_cfg.py'
config.JobType.psetName = 'ecalvalidationMCMiniAOD_cfg.py'

#config.Data.useParent = True
#config.JobType.maxMemoryMB = 4000

#config.Data.inputDataset = '/ZeroBias/Run2017C-12Sep2017-v1/MINIAOD'
config.Data.inputDataset = '/RelValNuGun/CMSSW_9_2_15-PU25ns_92X_upgrade2017_realistic_forECALFR_v2_HS_PF16-v1/MINIAODSIM'
