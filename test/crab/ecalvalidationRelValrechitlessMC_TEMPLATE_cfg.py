...
process.source = cms.Source("PoolSource",
    ...
    "root://eoscms.cern.ch//eos/cms/store/relval/CMSSW_6_1_1_SLHCphase1tk1-POSTLS161_V15/RelValSingleElectronPt35_UPG2017/GEN-SIM-DIGI-RAW/v1/00000/40B892C7-6081-E211-9815-002481E94B9C.root"
    )
)
...
process.load("Validation.EcalValidation.ecalvalidation_RelVal_rechitless_cfi")

process.TFileService = cms.Service("TFileService",
    fileName = cms.string('EcalValidation_RelValSingleElectronPt35_UPG2017_CMSSW_6_1_1_SLHCphase1tk1-POSTLS161_V15-v1_GEN-SIM-DIGI-RAW.root')
)
