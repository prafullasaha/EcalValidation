...
ecalvalidation = cms.EDAnalyzer("EcalValidationMiniAOD",
basicClusterCollection_EB = cms.InputTag("reducedEgamma"      ,       "reducedEBEEClusters"),
superClusterCollection_EB = cms.InputTag("reducedEgamma"  ,           "reducedSuperClusters"),
basicClusterCollection_ES = cms.InputTag("reducedEgamma" ,            "reducedESClusters"),
...
#
    ...
    ethrEB = cms.double(1.0),
    ethrEE = cms.double(1.0),
  #  ethrEB = cms.double(4.0),
  #  ethrEE = cms.double(0.0),
    gainId = cms.double(3.0),
    scEtThrEB = cms.double(2.0),
    scEtThrEE = cms.double(2.0),
    bcEtThrEB = cms.double(2.0),
    bcEtThrEE = cms.double(2.0),
